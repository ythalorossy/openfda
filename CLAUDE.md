...
- **`tests/`**: Vitest test suite (364 tests across 37 files: ApiHandler, catalog-conformance, catalog-coverage, catalog-shape, core/budget, core/codes, core/descriptor, core/envelope, core/escape, core/executor, core/http, core/project, core/query, core/registry, core/strategy, datasets/drug-drugsfda, datasets/drug-event, datasets/drug-label, datasets/drug-ndc, datasets/faers, docs-currency, drift-guard, env, faers-codes, format, label-fields, ndc, ndc-formats, no-raw-query, no-url-in-output, OpenFDABuilder, redact, registration, schema-budget, ToolManager, ToolManager.keyguard, version)
...
- **`src/datasets/drug/label.ts`, `event.ts`, `drugsfda.ts`, `ndc.ts`**: One `EndpointDescriptor` each — `drug-label`, `drug-event`, `drug-drugsfda`, `drug-ndc`.
